...
public class Edge implements Comparable<Edge> { 
    ...
    private ArrayList<Edge> ccmAsoc;
    ...
    public void asociarLado(ArrayList<Edge> listaLados) {
        ccmAsoc = listaLados;
    }

    public ArrayList<Edge> ccmAsoc() {
        return ccmAsoc;
    }

    /** 
     * Retorna el costo del camino de costo minimo asociado, si lo tiene.
     */
    public double costoCCM() {
        if (ccmAsoc != null) {
            double costo = 0;
            for (Edge e : ccmAsoc)
    ...
    public String toString() {
        return String.format("%d-%d %.3f", v+1, w+1, weight);
    }
