...
public class AdjMatrixDigraph {
	...
	public boolean containsEdge(int v, int w) {
        ...
        validateVertex(w);
        Arc e = adj[v][w];
		return (e == null) ? false : (e.from() == v && e.to() == w);
	}
	
    // Retorna una lista con las adyacencias del vertice dado.
    ...
    // Retorna una lista con los predecesores del vertice dado.
    ...
    // Retorna el grado interior del vertice dado.
    ...
    // Retorna el grado exterior del vertice dado.
    ...
    public static void main(String[] args) {
	 ...
	 StdOut.println(G);
     System.out.println(G.outdegree(9));
    }
}
